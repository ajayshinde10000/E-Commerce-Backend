...
class UserOrderController{
    ...
    static confirmOrder = async(req,res)=>{
        ...
        else if(cvv.length!=3 || cvv=="" || cvv==undefined || cvv==null){
            return res.send({
                code: 400,
    ...
    static getOrders = async(req,res)=>{
        ...
        static getUsersByQuery = async (filterParams, id) => {
          try {
            let query = sellerOrderModel.find({ "createdBy": id });
            ...
            const countQuery = sellerOrderModel.find({ "createdBy": id}).countDocuments();
